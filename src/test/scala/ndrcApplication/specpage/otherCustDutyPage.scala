...
class otherCustDutyPage extends commonMethods {
  ...
  def clearOtherDutyPaid(): Unit = Driver.instance.findElement(By.id("ActualPaidAmount")).clear()

  def clearOtherDutyBeenPaid(): Unit = Driver.instance.findElement(By.id("ShouldHavePaidAmount")).clear()
