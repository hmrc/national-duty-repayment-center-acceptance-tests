...
class entriesPage extends commonMethods {
  ...
  def selectOneEntry(): Unit   = Driver.instance.findElement(By.cssSelector("#value")).click()
  def selectMultiEntry(): Unit = Driver.instance.findElement(By.cssSelector("#value-2")).click()
