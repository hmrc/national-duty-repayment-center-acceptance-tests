...
class vatPage extends commonMethods {
  ...
  def clearImpVATPaid(): Unit = Driver.instance.findElement(By.id("ActualPaidAmount")).clear()

  def clearImpVATBeenPaid(): Unit = Driver.instance.findElement(By.id("ShouldHavePaidAmount")).clear()
