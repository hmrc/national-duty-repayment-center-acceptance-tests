...
class UploadFileSpec extends BaseSpec {
  ...
  Feature("Upload supporting files") {
    ...
    Scenario("Upload supporting files scenarios") {
      ...
      Then("I see an error message This file has already been uploaded")
        thenISeeAnErrorMessageX("This file has already been uploaded")  // auto-chosen (score=1.00, UploadFileStepsSteps.scala)
        // --- Other possible matches ---
        // thenAnErrorMessageIsDisplayed() [0.58] (CommonStepsSteps.scala) pattern: An error message is displayed- Error: \"([^\"]*)\"

      When("I click on Choose file button and add the second file")
        whenIClickOnChooseFileButtonAndAddTheXFile("second")  // auto-chosen (score=0.70, UploadFileStepsSteps.scala)
        // --- Other possible matches ---
        // whenIClickOnChooseFileButtonAndAddTheXFile() [0.70] (UploadFileStepsSteps.scala) pattern: I click on Choose file button and add the "([^"]*)" file
        // whenIClickTheFileContinueButton() [0.58] (FileUploadedStepsSteps.scala) pattern: I click the file continue button
        // whenIClickOnTheXButtonOnFeedbackForm() [0.52] (FeedbackFormStepsSteps.scala) pattern: I click on the \"([^\"]*)\" button on feedback form
    ...
    Scenario("Upload supporting files scenarios - Amend case journey [referenceNo=NDRC2104261385QBULEC4B5]") {
      ...
      And("I enter valid Application NDRC2104261385QBULEC4B5")
        andIEnterValidApplication("NDRC2104261385QBULEC4B5")  // auto-chosen (score=1.00, ImporterPersonalDetailsStepsSteps.scala)
        // --- Other possible matches ---
