...
class ErrorMessagesAmendSpec extends BaseSpec {
  ...
  Feature("Error Scenarios Amend case Journey") {
    ...
    Scenario("Error messages for Amend case journey scenarios [referenceNo=NDRC2105261863OL4K3WXR2, splCharacterRefNo=NDRC2103151135EE6L6YKH3&*, wrongFormatRefNo=103151135EE6L6YKH, invalidLenRefNo=NDRC2103151135EE6L6]") {
      ...
      Then("An error message is displayed- Error: Enter the reference number")
        thenAnErrorMessageIsDisplayed("Enter the reference number")  // auto-chosen (score=0.70, ImporterPersonalDetailsStepsSteps.scala)
        // --- Other possible matches ---
      ...
      And("I enter Application NDRC2103151135EE6L6YKH3&* reference no with a special character")
        andIEnterApplicationReferenceNoWithASpecialCharacter("NDRC2103151135EE6L6YKH3&*")  // auto-chosen (score=0.70, AmendCaseRefNoStepsSteps.scala)
        // --- Other possible matches ---
      ...
      Then("An error message is displayed- Error: The reference number must only include letters a to z and numbers 0 to 9")
        thenAnErrorMessageIsDisplayed("The reference number must only include letters a to z and numbers 0 to 9")  // auto-chosen (score=0.70, CommonStepsSteps.scala)
        // --- Other possible matches ---
        // thenISeeAnErrorMessageX() [0.56] (UploadFileStepsSteps.scala) pattern: I see an error message \"([^\"]*)\"
      ...
      Then("I enter wrong format Application 103151135EE6L6YKH reference No")
        thenIEnterWrongFormatApplicationReferenceNo("103151135EE6L6YKH")  // auto-chosen (score=1.00, ImporterPersonalDetailsStepsSteps.scala)
        // --- Other possible matches ---
      ...
      Then("An error message is displayed- Error: Enter the reference number in the right format")
        thenAnErrorMessageIsDisplayed("Enter the reference number in the right format")  // auto-chosen (score=0.70, ImporterPersonalDetailsStepsSteps.scala)
        // --- Other possible matches ---
        // thenAnErrorMessageIsDisplayed() [0.70] (CommonStepsSteps.scala) pattern: An error message is displayed- Error: \"([^\"]*)\"
        // thenISeeAnErrorMessageX() [0.56] (UploadFileStepsSteps.scala) pattern: I see an error message \"([^\"]*)\"
      ...
      Then("I enter invalid length Application NDRC2103151135EE6L6 reference number")
        thenIEnterInvalidLengthApplicationReferenceNumber("NDRC2103151135EE6L6")  // auto-chosen (score=1.00, ImporterPersonalDetailsStepsSteps.scala)
        // --- Other possible matches ---
      ...
      Then("An error message is displayed- Error: The reference number must be 23 characters long")
        thenAnErrorMessageIsDisplayed("The reference number must be 23 characters long")  // auto-chosen (score=0.70, CommonStepsSteps.scala)
        // --- Other possible matches ---
        // thenISeeAnErrorMessageX() [0.56] (UploadFileStepsSteps.scala) pattern: I see an error message \"([^\"]*)\"
      ...
      Then("An error message is displayed- Error: Select if you want to send more supporting documents, or give us further information in writing")
        thenAnErrorMessageIsDisplayed("Select if you want to send more supporting documents, or give us further information in writing")  // auto-chosen (score=0.70, CommonStepsSteps.scala)
        // --- Other possible matches ---
      ...
      Then("An error message is displayed- Error: Enter the further information")
        thenAnErrorMessageIsDisplayed("Enter the further information")  // auto-chosen (score=0.70, ImporterPersonalDetailsStepsSteps.scala)
        // --- Other possible matches ---
        // thenAnErrorMessageIsDisplayed() [0.70] (CommonStepsSteps.scala) pattern: An error message is displayed- Error: \"([^\"]*)\"
        // thenISeeAnErrorMessageX() [0.56] (UploadFileStepsSteps.scala) pattern: I see an error message \"([^\"]*)\"
        // andIEnterXInCorrectFormatGB() [0.47] (EoriNoStepsSteps.scala) pattern: I enter \"([^\"]*)\" in correct format GB
      ...
      And("I enter further goods details- Details: Shoes Jeans Jackets")
        andIEnterFurtherGoodsDetails("Shoes Jeans Jackets")  // auto-chosen (score=1.00, ImporterPersonalDetailsStepsSteps.scala)
        // --- Other possible matches ---
