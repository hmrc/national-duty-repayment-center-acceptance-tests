...
class ImportersJourneySpec extends BaseSpec {
  ...
  Feature("Importers Journey") {
    ...
    Scenario(
      ...
      andIChooseMultipleApplicationReasons()
    ...
    Scenario(
      ...
      andIEnterCustomsDutyShouldHavePaidToHMRC("0.00")
      ...
      andIEnterImportVatBeenPaidToHMRC("0.00")
