...
class UKRegulationsSpec extends BaseSpec {
  ...
  Feature("UK Regulations scenarios") {
    ...
    Scenario("A user wants to complete a New Importers journey with UK regulations [YorNvat=Yes, fName=Test, lName=Importer, YorNgoodsOwner=No, goodsOwner=Goods Owner, phoneNo=09876543212, emailAddress=test@mail.com, YorNDeclarantRefNO=Yes, declarantRefNo=123abcxyz]") {
