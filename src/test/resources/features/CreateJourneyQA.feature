Feature: Create Journey QA
  ...
  Scenario Outline: A user wants to complete a New Multi entry Representatives journey with Proof of Authority upload
    ...
    Examples:
      | YorNeori  | eoriNo          | noOfEntries | YorNvat | impName          | addLine        | city           | county        | postCode   | country         | agentEoriNo        | declarantName       | businessName    | agentaddLine  | agentcity    | agentcounty    | agentpostCode  | agentcountry    | phoneNo       |  emailAddress    | YorNDeclarantRefNO  | declarantRefNo | yOrNoIndirectRep | aName    | sCode       | accNo         |
      | Yes       | GB123456789123  | 9            | Yes    | test importer    | 2 Rue Des Fleurs | Paris        |               |            | France          | GB123456789123001  | test declarant      | test agent      | 27 rue National  | LIBOURNE     |              |               | France         | 09876543212    |  test@gmail.com  |  Yes                |  123abcxyz     |       No         | Megacorp | 207106      | 86563611      |
