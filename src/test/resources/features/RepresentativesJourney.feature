Feature: Representatives Journey
  ...
  Scenario Outline: A user wants to complete a New Representatives journey
    ...
    Examples:
      ...
      | No            |    Yes      | GB123456789123   | Yes     | test importer      | 23 Ludgatehill | Manchester      | Lancashire    |  M239SA    | United Kingdom  | GB123456789123001  | test declarant      | test agent   | 2 Piccadilly  | Bradford     | Yorkshire      | BD232AJ        | United Kingdom  | 09876543212   |  test@gmail.com   | Bank transfer (Bacs)  |  Yes                | 123abcxyz      |     No           | Megacorp | 207106      | 86563611      |
  ...
  Scenario Outline: A user wants to complete a New Multi entry Representatives journey
    ...
    When I click on the "Continue" button
    Then I am on "Enter the importer’s business bank details - Apply for repayment of import duty and import VAT - GOV.UK" page
    And I enter account "<aName>" and sortcode "<sCode>" and account number "<accNo>"
    When I click on the "Continue" button
    Then I am on "Check your answers before sending your information - Apply for repayment of import duty and import VAT - GOV.UK" page
    When I click on the "Continue" button
