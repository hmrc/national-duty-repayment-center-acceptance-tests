error id: file://<WORKSPACE>/src/test/scala/ndrcApplication/specs/AmendCYAPageSpec.scala:
file://<WORKSPACE>/src/test/scala/ndrcApplication/specs/AmendCYAPageSpec.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -ndrcApplication/specsteps/whenIClickOnTheXButton.
	 -ndrcApplication/specsteps/whenIClickOnTheXButton#
	 -ndrcApplication/specsteps/whenIClickOnTheXButton().
	 -ndrcApplication/specsteps/LoginPageStepsSteps.whenIClickOnTheXButton.
	 -ndrcApplication/specsteps/LoginPageStepsSteps.whenIClickOnTheXButton#
	 -ndrcApplication/specsteps/LoginPageStepsSteps.whenIClickOnTheXButton().
	 -whenIClickOnTheXButton.
	 -whenIClickOnTheXButton#
	 -whenIClickOnTheXButton().
	 -scala/Predef.whenIClickOnTheXButton.
	 -scala/Predef.whenIClickOnTheXButton#
	 -scala/Predef.whenIClickOnTheXButton().
offset: 865
uri: file://<WORKSPACE>/src/test/scala/ndrcApplication/specs/AmendCYAPageSpec.scala
text:
```scala
/*
...
import ndrcApplication.specsteps._
import ndrcApplication.specsteps.LoginPageStepsSteps._
import ndrcApplication.specsteps.thenIAcceptCookiesAndHideMessage.
import ndrcApplication.specsteps.wh@@enIClickOnTheXButton
