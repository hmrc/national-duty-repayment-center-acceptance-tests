...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Literal(Constant('))
       tree position: line 167 of file://<WORKSPACE>/src/test/scala/ndrcApplication/specsteps/stepdefsSteps.scala
            tree tpe: String("\'")
              symbol: null
...
== Source file context for tree position ==
   ...
   167       println("My input is " + _CURSOR_resHMRC + " and response is " + ResToHMRCResponse.getText + "'")
   168     }
   169     
   170 
