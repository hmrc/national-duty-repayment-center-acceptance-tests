error id: file://<WORKSPACE>/src/test/scala/ndrcApplication/specs/VATRegistrationSpec.scala:ndrcApplication/specsteps/StepDefsSteps.andIEnterEmail().
file://<WORKSPACE>/src/test/scala/ndrcApplication/specs/VATRegistrationSpec.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol ndrcApplication/specsteps/StepDefsSteps.andIEnterEmail().
empty definition using fallback
non-local guesses:

offset: 34883
uri: file://<WORKSPACE>/src/test/scala/ndrcApplication/specs/VATRegistrationSpec.scala
text:
```scala
/*
...
class VATRegistrationSpec extends BaseSpec {
  ...
  Feature("Importers Journey") {
    ...
    Scenario("VAT Registration Importers multi-entry journey [noOfEntries=8]") {
      ...
      And("I enter 8 value")
        andIEnterE@@mail("")  // auto-chosen (score=1.00, ImporterPersonalDetailsStepsSteps.scala)
        // --- Other possible matches ---
      ...
      And("I confirm VAT registration is displayed: Help with VAT registration You must register your business for VAT with HMRC if its VAT taxable turnover is over the current VAT registration threshold. You can register voluntarily if your turnover is under the threshold, unless everything you sell is exempt.")
        andIConfirmVATRegistrationIsDisplayed("")  // auto-chosen (score=1.00, VatRegStepsSteps.scala)
        // --- Other possible matches ---
